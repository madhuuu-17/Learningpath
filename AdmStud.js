...
export default function AdmStud() {
  ...
  return (
    ...
    <div className="admin-cont">
        <div className="addstudent container">
          ...
          <h1>Add New Student</h1><br></br><br></br><br></br>
            <label>Student Name:</label>
            &emsp;<input type='text' value={studentName} onChange={(e) => {setStudentName(e.target.value);}}/><br></br>
            <label>Rollno:</label>
            &emsp; <input type='number' value={rollno} onChange={(e) => {setRollno(e.target.value);}}/><br></br>
            <label>Department:</label>
            &emsp; <input type='text' value={department} onChange={(e) => {setDepartment(e.target.value);}}/><br></br>
            <label>Section:</label>
            &emsp;<input type='number' value={section} onChange={(e) => {setSection(e.target.value);}}/><br></br>
            <label>Batch:</label>
            &emsp;<input type='number' value={batch} onChange={(e) => {setBatch(e.target.value);}}/><br></br>
